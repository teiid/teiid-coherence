...
package org.teiid.translator.coherence.filter;
...
public class QueryLanguageExample
	...
	@Test public void testDefaultSearch() throws Exception {
	       ...
	       configureCache(cache, ff);
	       query(cache, ff);
	}	
	
	private void configureCache(NamedCache cache, FilterFactory ff) {
		System.out.println("------Configure NamedCache------");
